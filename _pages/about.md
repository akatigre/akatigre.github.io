  ...
  <div class="r-cards">
    ...
    <article class="r-card">
      ...
      <div class="r-card-footer">
        <a class="r-link" href="https://drive.google.com/file/d/1j38dsJT0iaE-C4bxd_DzsFQfUIq6btrX/view?usp=sharing"><i class="fas fa-file-pdf"></i> paper</a>
...
url={https://openreview.net/forum?id=Vl3tXPbjSH}
    ...
    <div class="r-pub">
      ...
      <div class="r-pub-row">
        <span class="r-badge r-badge-review">Under Review</span>
        <a class="r-link" href="https://drive.google.com/file/d/1j38dsJT0iaE-C4bxd_DzsFQfUIq6btrX/view?usp=sharing">paper</a>
        <button class="r-abs-btn" aria-expanded="false"><span class="r-toggle-label">Abstract +</span></button>
      </div>
